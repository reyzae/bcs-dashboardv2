...
<div class="card" id="addProductCard" style="margin-bottom: 2rem;">
    ...
    <div class="card-body" style="padding: 2rem;">
        <div style="display: grid; grid-template-columns: 1fr 320px; gap: 2rem;">
            ...
            <div>
                <form id="productForm">
                    ...
                    <div style="margin-bottom: 2rem; padding-bottom: 1.5rem; border-bottom: 2px solid #f3f4f6;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div class="form-group">
                                <label for="productPrice" class="form-label" style="font-size: 0.875rem; font-weight: 500;">
                                    <i class="fas fa-tag" style="color: #10b981;"></i> Selling Price (Rp) <span style="color: #ef4444; font-weight: 700;">*</span>
                                </label>
                                <input type="number" id="productPrice" class="form-input" placeholder="0" min="0" step="100" required>
                            </div>
                            <div class="form-group">
                                <label for="productCostPrice" class="form-label" style="font-size: 0.875rem; font-weight: 500;">
                                    <i class="fas fa-money-bill" style="color: #10b981;"></i> Cost Price (Rp)
                                </label>
                                <input type="number" id="productCostPrice" class="form-input" placeholder="0" min="0" step="100">
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem;">
                            <div class="form-group">
                                <label for="productStock" class="form-label" style="font-size: 0.875rem; font-weight: 500;">
                                    <i class="fas fa-cubes" style="color: #f59e0b;"></i> Stock Quantity <span style="color: #ef4444; font-weight: 700;">*</span>
                                </label>
                                ...
                                <label class="modern-toggle-switch" style="display: flex; align-items: center; justify-content: space-between; cursor: pointer; user-select: none;">
                                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                                        ...
                                        <div class="toggle-labels">
                                            <span class="toggle-label-active" style="font-weight: 600; color: #10b981; display: flex; align-items: center; gap: 0.5rem;">
                                                <i class="fas fa-check-circle"></i>
                                                <span>Active</span>
                                            </span>
                                            <span class="toggle-label-inactive" style="font-weight: 600; color: #ef4444; display: none; align-items: center; gap: 0.5rem;">
                                                <i class="fas fa-times-circle"></i>
                                                <span>Inactive</span>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="toggle-badge" style="background: linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%); color: #065f46; padding: 0.375rem 0.875rem; border-radius: 20px; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">
                                        <i class="fas fa-circle" style="font-size: 0.5rem; margin-right: 0.25rem; animation: pulse 2s ease-in-out infinite;"></i>
                                        <span class="badge-text">Available</span>
                                    </div>
                                </label>
                                <p style="margin: 0.75rem 0 0 0; font-size: 0.75rem; color: #6b7280; padding-left: 4rem;">
            ...
            <div style="position: sticky; top: 0; align-self: start;">
                ...
                <div style="background: white; border: 2px solid #e5e7eb; border-radius: 12px; padding: 1.5rem; margin-bottom: 1.5rem;">
                    ...
                    <div id="imageUploadContainer">
                        ...
                        <div id="imagePreviewArea" style="display: none;">
                            <div style="position: relative; border-radius: 12px; overflow: hidden; background: #f9fafb; aspect-ratio: 1/1;">
                                <img id="productImagePreview" src="" alt="Product" style="width: 100%; height: 100%; object-fit: cover;">
                                
                                <!-- Image Actions Overlay -->
                                <div class="image-actions-overlay" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.5); display: flex; align-items: center; justify-content: center; gap: 0.75rem; opacity: 0; transition: opacity 0.3s;">
                                    <button type="button" id="zoomImageBtn" class="image-action-btn" title="View Full Size">
                                        <i class="fas fa-search-plus"></i>
                                    </button>
                                    <button type="button" id="replaceImageBtn" class="image-action-btn" title="Replace Image">
                                        <i class="fas fa-sync-alt"></i>
                                    </button>
                                    <button type="button" id="deleteImageBtn" class="image-action-btn" title="Remove Image">
                            ...
                            <!-- Image Info -->
                            <div id="imageInfo" style="margin-top: 0.75rem; padding: 0.75rem; background: #f9fafb; border-radius: 8px; font-size: 0.75rem; color: #6b7280;">
                        ...
                        <div id="imageDropZone" class="image-drop-zone" style="border: 2px dashed #d1d5db; border-radius: 12px; padding: 2rem 1rem; text-align: center; background: #f9fafb; cursor: pointer; transition: all 0.3s;">
                            ...
                            <button type="button" id="selectImageBtn" class="btn btn-secondary" style="padding: 0.625rem 1.25rem; font-size: 0.875rem;">
                                <i class="fas fa-folder-open"></i> Choose File
                            </button>
                        </div>
                        
                        <!-- Hidden File Input -->
                        <input type="file" id="productImageInput" accept="image/jpeg,image/jpg,image/png,image/webp" style="display: none;">
                        
                        <!-- Upload Progress -->
                        <div id="uploadProgress" style="display: none; margin-top: 1rem;">
                            <div style="background: #e5e7eb; border-radius: 999px; height: 8px; overflow: hidden;">
                                <div id="uploadProgressBar" style="background: linear-gradient(90deg, #667eea 0%, #764ba2 100%); height: 100%; width: 0%; transition: width 0.3s;"></div>
                            </div>
                ...
                <div style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); border: 2px solid #0ea5e9; border-radius: 12px; padding: 1.5rem;">
                    <h4 style="margin: 0 0 1rem 0; font-size: 1rem; font-weight: 700; color: #0369a1; display: flex; align-items: center; gap: 0.5rem;">
                        <i class="fas fa-keyboard"></i> Keyboard Shortcuts
                    </h4>
                    
                    <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                        <!-- Shortcut Card -->
                        <div style="background: white; border: 1px solid #bae6fd; border-radius: 8px; padding: 0.875rem;">
                    ...
                    <!-- Pro Tip -->
                    <div style="margin-top: 1rem; padding: 0.875rem; background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border-left: 4px solid #f59e0b; border-radius: 6px;">
                        ...
                        <div style="font-size: 0.75rem; color: #78350f;">
                            Use <kbd style="font-size: 0.625rem; padding: 0.125rem 0.375rem;">Tab</kbd> to navigate between fields quickly!
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card" style="margin-bottom: 2rem;">
        ...
        <div class="form-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem;">
                ...
                <input type="text" id="searchInput" class="form-input" placeholder="Search by name or SKU..." autocomplete="off">
                </div>
                <div class="form-group">
